...
from lab7_v2 import find_neighbor_values
...
test_find_neighbor_bottom_edge()
test_find_neighbor_middle()
test_find_neighbor_values_bottom_left_corner()  
test_find_neighbor_values_bottom_right_corner()
test_find_neighbor_values_right_edge()
test_find_neighbor_values_top_edge()
test_find_neighbor_values_top_left_corner()
test_find_neighbor_values_top_right_corner()
test_find_neighbours_left_edge()